...
%Because MCMC methods depend only on the forward model and likelihood calculations associated with the model parameters, they are readily applied to both linear and nonlinear problems \citep{Aster2005a}.
