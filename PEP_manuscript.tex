...
A recent reevaluation of continental paleomagnetic records from Australia using published and new data by \cite{Hansma2019a} reconciles the previously contentious APW tracks derived from the paleomagnetic records (Table \ref{tab:Aus_Cenozoic_poles}; \cite{Idnurm1985a, Idnurm1994a, Musgrave1989a, Opdyke2004a, Hansma2018a}) with that from the global reconstructions (Figure \ref{fig:Aus_Cenozoic_track}). These constraints give us the opportunity to compare inverted results of PEP rotation rates to an independent plate tectonic reconstruction.
